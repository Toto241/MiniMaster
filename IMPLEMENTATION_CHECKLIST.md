...
- [ ] **Legacy `secretKey` Cutover**: Backend-Migration + koordinierte Mobile-Client-Versionierung
  ...
  - [ ] Stufe 2: Repo-Clients von `masterImei + secretKey` lösen (web-control, parent-panel, child-panel, iOS AuthService)
    ...
    - [ ] Web-Control / Parent-Panel / Child-Panel: Legacy-Initiallogin nach Migrationsfenster entfernen und final auf Bootstrap/Session-Flow umstellen
  - [ ] Stufe 3: 14 Tage Nullnutzung via Legacy-Auth-Monitor als Release-Gate, dann expliziter Hard-Cut
