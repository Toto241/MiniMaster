...
export function loadAdminPanelTestExports(initialStorage: StorageMap = {}): AdminPanelHarness {
  ...
  const exportTrailer = [
    ...
    "  renderQaPlatformOverview,",
    "  renderEmulatorLabOverview,",
    "  loadQaPlatformCatalog,",
    "  loadEmulatorLabOverview,",
    "  loadSuiteDeviceStatus,",
    "  renderQaSelfHealingStatus,",
    "  loadQaSelfHealingStatus,",
    "  runQaSelfHealingCycle,",
    ...
    "  loadQaReleaseWorkspace,",
    "  copySelectedQaReleaseBlocker,",
    "  copyQaReleaseWorkspaceSummary,",
    "  rerunSelectedQaReleaseBlocker,",
    ...
    "  setQaReleaseWorkspacePayloadForTests: (value) => { qaReleaseWorkspacePayload = value; },",
    "  setQaReleaseSelectedBlockerIdForTests: (value) => { qaReleaseSelectedBlockerId = value; },",
