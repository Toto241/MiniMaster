    ...
    },
    {
        ...
        "tests": (
            ...
            },
            {
                ...
                "description": "Automatischer statischer Nachweis fuer Reject-UI, String-Ressource und rejectTask-Anbindung im TaskReview-Flow der MasterApp.",
                "automationType": "automatic",
                "source": "static-analysis",
                "successCriteria": "TaskReviewScreen enthaelt Reject-UI samt String-Ressource, und die rejectTask-Callable ist in der MasterApp verdrahtet.",
            },
            {
            ...
            },
            {
                ...
                "description": "Automatischer Nachweis ueber verknuepfte Repository-Tests: Die MasterApp mappt task_pending_approval- und device_status_change-Nachrichten auf die korrekten Notification-Kanaele und Payloads.",
                "automationType": "automatic",
                "source": "repo-test",
                "suiteRef": "android-unit-master",
                "successCriteria": "Android-Unit-Tests pruefen die Routing-Logik fuer Task-Approval- und Device-Status-FCM-Nachrichten inklusive Kanal- und Extra-Zuordnung.",
            },
            {
            ...
            },
            {
                ...
                "description": "Automatischer statischer Nachweis fuer QR-Pairing im Parent-Flow: Backend-Payload, QR-Encoder und Compose-Anzeige sind in der MasterApp verdrahtet.",
                "automationType": "automatic",
                "source": "static-analysis",
                "successCriteria": "Die MasterApp uebernimmt qrCodeValue/pairingLink aus dem Backend und rendert einen scanbaren QR-Code im LinkGenerationSection-Flow.",
            },
        ),
    },
    {
    ...
    },
    {
        ...
        "tests": (
            ...
            },
            {
                ...
                "description": "Automatischer Nachweis ueber verknuepfte Repository-Tests: Der Electron-Main-Process persistiert Parent-/Operator-Fensterbounds in userData und stellt sie beim Start wieder her.",
                "automationType": "automatic",
                "source": "repo-test",
                "suiteRef": "backend-jest",
                "successCriteria": "Repository-Tests pruefen das Laden persistierter Bounds sowie das Speichern des Fensterzustands beim Schliessen beider Desktop-Fenster.",
            },
            {
                "id": "dt-ipc-messaging",
            ...
            },
            {
                ...
                "description": "Automatischer Nachweis ueber verknuepfte Repository-Tests: Der Electron-Main-Process registriert Handler fuer uncaughtException, unhandledRejection und Process-Crashes und schreibt strukturierte Crash-Journal-Eintraege nach userData.",
                "automationType": "automatic",
                "source": "repo-test",
                "suiteRef": "backend-jest",
                "successCriteria": "Repository-Tests pruefen die Registrierung der Crash-Handler sowie das Schreiben strukturierter Crash-Eintraege in die lokale Desktop-Crash-Journal-Datei.",
            },
        ),
    },
    {
        ...
        "tests": (
            ...
            {
                "id": "static-ma-task-reject-ui",
                "title": "Reject-UI im TaskReview-Flow implementiert",
                "description": "Prueft, ob TaskReviewScreen eine Reject-Aktion, die String-Ressource und die rejectTask-Anbindung enthaelt.",
                "automationType": "automatic",
                "source": "static-analysis",
                "successCriteria": "Reject-UI, String-Ressource und rejectTask-Callable sind im MasterApp-Code vorhanden.",
            },
            {
                "id": "static-ma-qr-pairing",
                "title": "QR-Pairing im Parent-Flow implementiert",
                "description": "Prueft, ob Pairing-Link/qrCodeValue aus dem Backend bis zur Compose-QR-Anzeige in der MasterApp verdrahtet sind.",
                "automationType": "automatic",
                "source": "static-analysis",
                "successCriteria": "Backend-Payload, QR-Encoder und Compose-QR-Anzeige sind im MasterApp-Code vorhanden.",
            },
        ),
    },
    {
...
STATIC_ANALYSIS_RESULT_ALIASES = {
    ...
    "ma-task-reject-ui": "static-ma-task-reject-ui",
    "static-ma-task-reject-ui": "static-ma-task-reject-ui",
    "ma-qr-pairing": "static-ma-qr-pairing",
    "static-ma-qr-pairing": "static-ma-qr-pairing",
