...
SUITES: tuple[Suite, ...] = (
    ...
    Suite("python-tests-emulator-manager", "Python emulator manager tests", "python", [sys.executable, "-m", "pytest", "-c", str(REPO_ROOT / "scripts" / "pytest.ini"), str(REPO_ROOT / "scripts" / "tests" / "test_emulator_manager.py")], ("python_pytest",), timeout_sec=1800),
